...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outExpAr}\;\Conid{X}{}\<[13]%
\>[13]{}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{num})\mathrel{=}i_2\;(i_1\;(\Varid{num})){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{a1}\;\Varid{a2}){}\<[22]%
\>[22]{}\mathrel{=}i_2\;(i_2\;((i_2\;(\Varid{a1},\Varid{a2})))){}\<[E]%
\\
...
\\
\>[B]{}\mbox{\onelinecomment g_eval_exp a X = a}{}\<[E]%
\\
